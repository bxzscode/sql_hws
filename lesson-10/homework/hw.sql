...
--2
select c.firstname + c.lastname as FullName , o.orderdate from customers c
join orders o
...
--5
select o.orderid , o.orderdate , p.paymentdate , o.totalamount from orders o
left join payments p
on o.orderid = p.orderid

--6
select e.[name] as empname , e2.[name] as managername from employees e
join employees e2 
...
--8 
select c.firstname , c.lastname , o.quantity from orders o
join customers c
on c.customerid = o.customerid
where o.quantity > 3
...
-- mediumlvl
--10
select departmentname , count(e.employeeid) as EmployeeCount from departments d
join employees e
on e.DepartmentID = d.DepartmentID
...
--15
select o.orderID , o.orderdate , c.firstname + c.lastname as fullname from customers c
join orders o
on c.customerid = o.customerid
...
join departments d
on e.DepartmentID = d.DepartmentID
where d.departmentid = 1 and e.salary > 60000
...
group by e.departmentid , e.salary , e.[name]
...
--22
select e.[name] as employee1 , e2.[name] as employee2 , e.managerid , e.salary from employees e
join employees e2
on e.managerid = e2.managerid and e.employeeid > e2.employeeid
where e.salary > 60000 and e2.salary > 60000
...
--25
select e.STUDENTID , s.[name] from students s
join enrollments e
on s.studentid = e.studentid
join courses c
on e.courseid = c.courseid
